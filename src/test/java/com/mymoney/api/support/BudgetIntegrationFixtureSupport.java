...
@Component
public class BudgetIntegrationFixtureSupport {
    ...
    public BudgetIntegrationFixtureSupport(
    ...
    public FamilyMember createAllowanceMember() {
        return identityFixtureSupport.persistAllowanceMember("Karol", "karol-budget@bolso-em-dia.local", "karol123456");
    }
    ...
    public Budget createGlobalBudget(Category groceries, Category transport) {
        return entityFixtureSupport.persistBudget(created -> {
    ...
    public Budget createAllowanceBudget(FamilyMember allowanceMember) {
        return entityFixtureSupport.persistBudget(created -> {
    ...
    public void createSharedGroceriesTransaction(Account account, Category groceries) {
    ...
    public void createAllowanceTransportTransaction(Account account, Category transport, FamilyMember allowanceMember) {
        entityFixtureSupport.persistTransaction(created -> {
            created.setType(TransactionType.EXPENSE);
